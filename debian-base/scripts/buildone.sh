...
#
#   - Produce exactly the same base tarball. `makeimage.sh` will take care of that
...
build() {
    ...
    log "============================================"
    ./makeimage.sh "build/$TAG.tar" "$DIST" "$PLATFORM"
    ...
    log "============================================"
    ./makeimage.sh "build/${TAG}-repro.tar" "$DIST" "$PLATFORM"
